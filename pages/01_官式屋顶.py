...
with col_right:
    ...
    with st.container(border=False):
        ...
        st.markdown(
            """<div class="analysis"><b>分析：</b><br>建筑规制越高，屋顶样式种类越丰富。皇家建筑群样式最全，地方官署、县衙样式逐级减少，彰显古代建筑的礼制层级秩序。</div>""",
            unsafe_allow_html=True)