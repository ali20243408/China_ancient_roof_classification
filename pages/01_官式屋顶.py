...
with col_left:
    ...
    with st.container(border=False):
        ...
        st.markdown("""<div class="analysis"><b>分析：</b><br>屋顶等级与数量呈反比；等级越低数量越多，高等级屋顶严格限量，体现封建等级制度。</div>""", unsafe_allow_html=True)
...
with col_right:
    with st.container(border=False):
        ...
        st.markdown("""<div class="analysis"><b>分析：</b><br>高等级屋顶仅存于皇家建筑群，地方官署以普通屋顶为主，体现古代建筑等级规制。</div>""", unsafe_allow_html=True)
    ...
    with st.container(border=False):
        ...
        st.markdown("""<div class="analysis"><b>分析：</b><br>建筑规格越高，高等级屋顶占比越多，从古建布局直观体现礼制层级秩序。</div>""", unsafe_allow_html=True)